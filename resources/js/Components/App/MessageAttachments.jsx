                    ...
                    >
                        {!isAudio(attachment) && (
                            <a
                                ...
                                transition-all  w-8 h-8 flex item-center justify-center
                                text-gray-100 bg-gray-700 rounded absolute right-0 
                        ...
                        {isPDF(attachment) && (
                            <div className="relatve flex justify-center items-center">
                                <div className="absolute left-0 top-0 right-o bottom-0"></div>
                                <iframe
                                    src={attachment.url}
