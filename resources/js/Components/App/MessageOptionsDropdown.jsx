...
import { EllipsisVerticalIcon, ShieldCheckIcon, UserIcon, TrashIcon } from "@heroicons/react/24/solid";
        ...
        <div className="absolute right-full text-gray-100 top-1/2 -translate-y-1/2 z-10">
            <Menu as="div" className="relative inline-block text-left">
                <div>
                    ...
                    >
                        <Menu.Items className="absolute left-0 mt-2 w-48 rounded-md bg-gray-800
                        shadow-lg z-50">
